...
grafana: roles/master/files/grafana-12.0.1.linux-amd64.tar.gz
	ansible-playbook -i inventory.yaml playbook.yaml --tags grafana

roles/master/files/grafana-12.0.1.linux-amd64.tar.gz:
	curl https://dl.grafana.com/oss/release/grafana-12.0.1.linux-amd64.tar.gz -o roles/master/files/grafana-12.0.1.linux-amd64.tar.gz
