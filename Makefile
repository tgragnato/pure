...
grafana: roles/services/files/grafana-11.2.0.linux-amd64.tar.gz

roles/services/files/grafana-11.2.0.linux-amd64.tar.gz:
	curl https://dl.grafana.com/oss/release/grafana-11.2.0.linux-amd64.tar.gz -o roles/services/files/grafana-11.2.0.linux-amd64.tar.gz
